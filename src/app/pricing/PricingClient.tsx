...
export default function PricingClient({ isPro }: PricingClientProps) {
  ...
  // Paddle Price IDs
  const monthlyVariantId = process.env.NEXT_PUBLIC_PADDLE_PRICE_ID_MONTHLY || "pri_monthly_placeholder"; 
  const yearlyVariantId = process.env.NEXT_PUBLIC_PADDLE_PRICE_ID_YEARLY || "pri_yearly_placeholder"; 
