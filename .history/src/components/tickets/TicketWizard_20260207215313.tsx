            ...
            <div className={styles.card}>
                <div className={styles.resultLayout}>
                    <div className={styles.mainContent}>
                                            ...
                                            img: ({node, ...props}) => {
                                                ...
                                                return (
                                                  <img 
                                                    ...
                                                    alt={props.alt || ''}
                                                    onClick={() => setLightboxSrc(props.src as string)}
                        ...
                        {/* Reference Gallery - Always show images at the bottom for context */}
                        <div className={styles.gallerySection}>
                            <h3 className={styles.galleryTitle}>Reference Screens</h3>
                            <div className={styles.screenshotGrid}>
                                {formData.screenshots.map((shot, idx) => (
                                    <div key={shot.id} className={styles.galleryCard}>
                                        <div className={styles.galleryImageWrapper}>
                                            <img src={shot.preview} alt={shot.description} />
                                            <span className={styles.galleryIndexBadge}>{idx}</span>
                                        </div>
                                        <p className={styles.galleryCaption}>{shot.description || 'Screenshot'}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
  ...
  return (
    <div className={styles.wizardContainer}>
      {lightboxSrc && (
        <div className={styles.lightboxOverlay} onClick={() => setLightboxSrc(null)}>
            <div className={styles.lightboxContent} onClick={(e) => e.stopPropagation()}>
                <img src={lightboxSrc} className={styles.lightboxImage} alt="Fullscreen" />
                <button className={styles.lightboxClose} onClick={() => setLightboxSrc(null)}>
                    <X size={24} />
                </button>
            </div>
