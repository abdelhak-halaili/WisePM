            ...
            <header className={styles.resultHeader} style={{ marginBottom: '1rem' }}>
                 <div>
                    ...
                    <div className={styles.headerMeta}>
                       ...
                       <span className={styles.dateBadge}><Calendar size={12} style={{ marginRight: 4 }}/> {new Date(ticket.createdAt).toLocaleDateString()}</span>
                    </div>
                    ...
                    <div className={styles.documentContainer}>
                        {isEditing ? (
                            <textarea 
                                ...
                                value={currentTicket.coreContent}
                                onChange={(e) => setCurrentTicket({ ...currentTicket, coreContent: e.target.value })}
                    ...
                    <div className={styles.chatContainer} style={{ display: activeTab === 'chat' ? 'flex' : 'none' }}>
                        ...
                        <div className={styles.chatInputArea}>
                            <textarea
                                ...
                                placeholder="Type to refine logic or ask questions..."
                                rows={1}
                                value={chatInput}
