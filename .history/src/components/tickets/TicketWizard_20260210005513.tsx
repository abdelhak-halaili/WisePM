...
export default function TicketWizard() {
  ...
  const handleJiraExport = () => {
    ...
    // URL: https://[domain]/secure/CreateIssue!default.jspa?summary=...&description=...
    
    const url = `https://${domain}/secure/CreateIssueDetails!init.jspa?pid=&issuetype=&summary=${summary}&description=${description}` 
    // Provide a way to copy if it fails?
    // Let's try to be smarter. 
    // If we just use CreateIssue!default.jspa, it might retain the user's last project.
    
    window.open(`https://${domain}/secure/CreateIssue!default.jspa?summary=${summary}&description=${description}`, '_blank')
  }
