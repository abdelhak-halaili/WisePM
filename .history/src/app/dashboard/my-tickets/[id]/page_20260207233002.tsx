...
export default async function TicketDetailsPage({ params }: Props) {
  ...
  if (ticket) {
    console.log(`[Details] Ticket ${ticket.id} loaded.`);
    console.log(`[Details] Content Length: ${ticket.content?.length}`);
    console.log(`[Details] Has Base64 Image: ${ticket.content?.includes('data:image')}`);
  }
