...
export default function PricingPage() {
  ...
  const monthlyVariantId = process.env.NEXT_PUBLIC_LEMONSQUEEZY_VARIANT_ID_MONTHLY || "618585"; 
  const yearlyVariantId = process.env.NEXT_PUBLIC_LEMONSQUEEZY_VARIANT_ID_YEARLY || "618586"; 
